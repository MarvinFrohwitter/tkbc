...
void kite_script_input(Env *env) {
  ...
  kite_register_frames(
      ...
      kite_gen_frame(KITE_MOVE_ADD,
                     kite_indexs_append(0, 1, 2, 3, 4, 5, 6, 7, 8),
  ...
  kite_script_team_grid(env, kite_indexs_append(0, 1, 2, 3, 4, 5, 6, 7, 8), 3,
                        3, 200, 200, 10);

  // kite_script_team_box_left(env, kite_indexs_append(0, 1, 2, 3), 300, 2);
  // kite_script_team_box_right(env, kite_indexs_append(0, 1, 2, 3), 300, 2);
  ...
  //                      kite_gen_frame(KITE_ROTATION, kite_indexs_append(3),
